...
<?php $counter = 0;
	while(plogger_picture_has_comments()) {
		...
		$comment_class = ($counter % 2) ? 'comment' : 'comment-alt';
?>
...
<?php } if (plogger_comment_moderated()) { ?>
				<p class="actions"><?php echo plog_tr('Your comment was placed in moderation, please wait for approval.<br />Do not submit your comment again!'); ?></p>
<?php } ?>
